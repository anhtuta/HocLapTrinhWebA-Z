function doFirst() {
	...
	/*
	Rõ ràng là ko cần tham chiếu tới các đối tượng bên file .html như sau:
...
function playOrPause() {
	if(!myMovie.paused && !myMovie.ended) {//click playBtn khi video đang chạy: ta sẽ pause movie
		myMovie.pause();
