function doFirst() {
	...
	myMovie = document.getElementById('warcoc');
...
function updateProgressbar() {
	if(!myMovie.ended) {
		var size=parseInt(myMovie.currentTime*barSize/myMovie.duration);  /*Ví dụ myMovie.duration = 3min, myMovie.currentTime = 1min26s myMovie.currentTime/myMovie.duration = số phần trăm của video đã play đc, lấy số phần trăm đó thiết lập cho progressBar*/
